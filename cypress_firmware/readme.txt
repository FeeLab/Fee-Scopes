Feescope firmware for EZ-USB FX3 HD 720P DAQ board. Only for use with the
kiloscope and featherscope.

Modifications to stock firmware made by Galen Lynch.

Follow instructions in cypress EZ_USB FX3 SDK
(https://www.cypress.com/documentation/software-and-drivers/ez-usb-fx3-software-development-kit)
for installing the software environment needed to build the firmware and program
the DAQ board.

Details on programming the DAQ board, which is a slightly modified UCLA
miniscope v3 DAQ board, can be found on the UCLA miniscope wiki for miniscope v3
(http://miniscope.org/index.php/Software_and_Firmware_Setup).

Cypress README below:
